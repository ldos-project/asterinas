...
/// - `predicate`: A closure that returns a boolean. The function will exit as soon as this closure returns `true`.
pub fn sleep_with_predicate<F>(d: Duration, mut predicate: F)
where
    F: FnMut() -> bool,
{
...
/// Macro to assert that a condition becomes true within a timeout (specified or a [default](`DEFAULT_TIMEOUT`)).
///
/// # Usage:
/// ```no_run
/// assert_eventually!(value == 1); // Uses DEFAULT_TIMEOUT
/// assert_eventually!(value == 1, "Value did not become 1"); // No trailing comma for message only
/// assert_eventually!(value == 1, timeout = Duration::from_millis(200)); // No trailing comma for timeout only
/// assert_eventually!(value == 1, timeout = Duration::from_millis(200), "Value did not become 1"); // Both timeout and message with trailing comma
/// ```
#[macro_export]
...
/// Macro to assert that two expressions become equal within a timeout (specified or a [default](`DEFAULT_TIMEOUT`)).
///
/// # Usage:
/// ```no_run
/// assert_eq_eventually!(value, 1); // Uses DEFAULT_TIMEOUT
/// assert_eq_eventually!(value, 1, "Value should be equal to 1"); // No trailing comma for message only
/// assert_eq_eventually!(value, 1, timeout = Duration::from_millis(200)); // No trailing comma for timeout only
/// assert_eq_eventually!(value, 1, timeout = Duration::from_millis(200), "Value should be equal to 1"); // Both timeout and message with trailing comma
/// ```
#[macro_export]
...
/// Macro to assert that two expressions become unequal within a timeout (specified or a [default](`DEFAULT_TIMEOUT`)).
///
/// # Usage:
/// ```no_run
/// assert_ne_eventually!(value, 1); // Uses DEFAULT_TIMEOUT
/// assert_ne_eventually!(value, 1, "Value should not be equal to 1"); // No trailing comma for message only
/// assert_ne_eventually!(value, 1, timeout = Duration::from_millis(200)); // No trailing comma for timeout only
/// assert_ne_eventually!(value, 1, timeout = Duration::from_millis(200), "Value should not be equal to 1"); // Both timeout and message with trailing comma
/// ```
#[macro_export]
...
/// Macro to assert that an expression matches a pattern within a timeout (specified or a [default](`DEFAULT_TIMEOUT`)).
///
/// # Usage:
/// ```no_run
/// assert_matches_eventually!(result, Some(_)); // Uses DEFAULT_TIMEOUT
/// assert_matches_eventually!(result, Some(_), "Result should be Some"); // No trailing comma for message only
/// assert_matches_eventually!(result, Some(_), timeout = Duration::from_millis(200)); // No trailing comma for timeout only
/// assert_matches_eventually!(result, Some(_), timeout = Duration::from_millis(200), "Result should be Some"); // Both timeout and message with trailing comma
/// ```
#[macro_export]
...
/// Helper macro to encapsulate common logic for assertion macros.
#[macro_export]
...
// Placeholder implementations for Jiffies and Task for testing purposes.
#[cfg(ktest)]
mod tests {
    use alloc::sync::Arc;
