...
use crate::orpc::oqueue::{ElementDescriptor, ReflessElementDescriptor};
...
impl<T: Copy + 'static> ObservationQuery<ReflessElementDescriptor<T>, T> {
...
mod test {
    ...
    #[ktest]
    fn new_extractor() {
        let query = ObservationQuery::<ReflessElementDescriptor<usize>, usize>::new(|v| *v + 1);
        assert_eq!(query.call(&41), Some(42));
    }

    #[ktest]
    fn new_filter() {
        let query = ObservationQuery::<ReflessElementDescriptor<isize>, isize>::new_filter(|v| {
