...
mod test {
    ...
    #[ktest]
    fn produce_consume_observable_locking() {
        let oqueue = ObservableLockingQueue::new(2, 5);
        test_produce_consume(oqueue);
    }

    #[ktest]
    fn produce_strong_observe_observable_locking() {
        let oqueue = ObservableLockingQueue::new(2, 5);
        test_produce_strong_observe(oqueue);
    }

    #[ktest]
    fn produce_weak_observe_observable_locking() {
        let oqueue = ObservableLockingQueue::new(2, 5);
