...
(such as [Asterinas](https://github.com/ldos-project/asterinas)):
...
(e.g., [Asterinas](https://github.com/ldos-project/asterinas)),
...
The `sctrace` tool originates from the [Asterinas](https://github.com/ldos-project/asterinas) project
...
```bash
git clone --depth 1 https://github.com/ldos-project/asterinas
