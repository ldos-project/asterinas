...
update_all_docker_version_refs() {
    ...
    # Update Docker image versions in devcontainer.template.json, README files, and AGENTS.md
    update_image_versions ${ASTER_SRC_DIR}/.devcontainer/devcontainer.template.json
