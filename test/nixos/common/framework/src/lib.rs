...
//!
//! See the [template crate](https://github.com/ldos-project/asterinas/tree/main/test/nixos/common/template)
//! for a usage example.
//!
//! See the [project README](https://github.com/ldos-project/asterinas/tree/main/test/nixos)
