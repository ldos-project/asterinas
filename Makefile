...
DOCKER_MOUNTS := -v $(shell pwd):/root/asterinas -v $(CARGO_CACHE):/root/.cargo -v $(RUSTUP_CACHE):/root/.rustup --device=/dev/nvme1n1p1:/dev/nvme1n1p1 --device=/dev/nvme0n1p1:/dev/nvme0n1p1 --device=/dev/nvme2n1p1:/dev/nvme2n1p1
